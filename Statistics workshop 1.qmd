...
#| eval: false
chol_1Sample |>
  rstatix::wilcox_effsize(LDL ~ 1, mu = 120)  #<1>
```
...
#| eval: true
chol_1Sample |>
  rstatix::wilcox_effsize(LDL ~ 1, mu = 120) |>
  kable(align = 'l')
```
...
#| eval: false
chol_2_ind_sample |>
  rstatix::wilcox_effsize(Cholesterol ~ Group) #<1>
```
...
#| eval: false
pair_chol_long |>
  rstatix::wilcox_effsize(Cholesterol ~ Before_After, paired = TRUE)  #<1>
```
...
#| eval: true
pair_chol_long |>
  rstatix::wilcox_effsize(Cholesterol ~ Before_After, paired = TRUE) |>
  kable(align = 'l')
```
